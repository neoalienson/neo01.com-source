---
title: "CISP学习指南：技术基础综合知识"
date: 2025-10-02
lang: zh-CN
available_langs: []
permalink: /zh-CN/2025/10/CISP-Technical-Fundamentals-Comprehensive/
excerpt: "全面覆盖恶意代码、密码学、网络协议、访问控制等CISP考试核心技术知识点。"
tags:
  - CISP
categories:
  - Cybersecurity
...
sequenceDiagram
    ...
    Note over S: 1. 计算消息摘要
    Note over S: 2. 用私钥签名摘要
    S->>R: 3. 发送消息+签名
    
    Note over R: 4. 计算消息摘要
    Note over R: 5. 用发送者公钥验证签名
    Note over R: 6. 比较摘要是否一致
