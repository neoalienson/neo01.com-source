---
title: "CISP学习指南：风险管理基础与背景建立"
date: 2025-10-15
categories:
  - Cybersecurity
tags:
  - CISP
excerpt: "深入解析CISP认证中的风险管理基础与背景建立知识点，涵盖背景建立、风险评估和风险处置等核心内容。"
lang: zh-CN
available_langs: []
permalink: /zh-CN/2025/10/CISP-Risk-Management-Basics/
...
从风险分析的观点来看，计算机系统存在多个潜在的弱点，其中最主要的弱点是**系统输入输出**。

!!!anote "💡 为什么系统输入输出是最主要弱点"
    **系统输入输出的脆弱性：**
...
根据《关于开展信息安全风险评估工作的意见》，信息安全风险评估分为**自评估**和**检查评估**两种形式。
...
!!!anote "💡 风险管理流程的关键阶段"
    **风险管理流程：**
    ...
    我国标准《信息安全风险管理指南》（GB/Z24364）给出了信息安全风险管理的内容和过程。风险评估之后的关键阶段是**风险处理**（也称风险处置）。
...
!!!anote "💡 关键系统应该内部实现"
    **核心系统的开发方式：内部实现**
    ...
    从风险的观点来看，具有任务紧急性和核心功能性的计算机应用程序系统的开发和维护项目应该**内部实现**。
...
{% echarts %}
{
  ...
  "legend": {
    "data": ["安全风险", "供应链风险", "控制风险"]
  },
  "xAxis": {
    "type": "category",
    "data": ["内部实现", "外部采购", "合作实现", "多来源合作"]
  },
  "yAxis": {
    "type": "value",
    "name": "风险等级",
