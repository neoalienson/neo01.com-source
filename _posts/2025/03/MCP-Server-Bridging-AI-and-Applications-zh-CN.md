---
title: "MCP服务器：连接AI与应用程序的桥梁"
date: 2025-03-12
categories: AI
tags: [AI, MCP, Integration]
excerpt: "探索模型上下文协议（MCP）服务器如何革新AI集成，实现语言模型与外部工具、数据库和API之间的无缝连接。"
lang: zh-CN
...
graph TB
    ...
    A -->|"Stdio<br/>（无认证）"| B
    A -->|"Stdio<br/>（无认证）"| C
    A -->|"HTTP + OAuth<br/>（Bearer令牌）"| D
    A -->|"HTTP + OAuth<br/>（Bearer令牌）"| E
    B -->|"文件I/O"| F
    C -->|"Git命令"| G
    D -->|"SQL"| H
    E -->|"HTTP"| I
