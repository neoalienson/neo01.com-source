...
**這是兩部分系列文章的第一部分。** 本文涵蓋基礎知識——什麼是 ADL、如何撰寫，以及真實範例。[第二部分](/zh-TW/2026/01/Architecture-Decision-Log-Advanced-Topics) 涵蓋跨團隊擴展 ADR、利害關係人管理和效果評估。
...
**[第二部分：進階主題](/zh-TW/2026/01/Architecture-Decision-Log-Advanced-Topics)** 涵蓋：
- 利害關係人管理和 RACI 模型
- 包含審查清單的完整 10 步工作流程
