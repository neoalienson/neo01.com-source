...
**這是兩部分系列文章的第二部分。**[第一部分](/zh-TW/2026/01/Architecture-Decision-Log-Guide) 涵蓋基礎知識——什麼是 ADL、每個 ADR 必須回答的五個問題，以及真實範例。如果你是 ADR 新手，從那裡開始。
...
- **[第一部分：實用指南](/zh-TW/2026/01/Architecture-Decision-Log-Guide)** — 學習基礎知識：什麼是 ADR、每個 ADR 必須回答的五個問題、真實電商範例，以及可直接複製的模板。
