...
**这是两部分系列文章的第一部分。** 本文涵盖基础知识——什么是 ADL、如何撰写，以及真实范例。[第二部分](/2026/01/Architecture-Decision-Log-Advanced-Topics-zh-CN) 涵盖跨团队扩展 ADR、利益相关人管理和效果评估。
...
**[第二部分：进阶主题](/2026/01/Architecture-Decision-Log-Advanced-Topics-zh-CN)** 涵盖：
- 利益相关人管理和 RACI 模型
- 包含审查清单的完整 10 步工作流程
