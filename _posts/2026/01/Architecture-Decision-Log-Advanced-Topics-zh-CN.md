...
**这是两部分系列文章的第二部分。**[第一部分](/zh-CN/2026/01/Architecture-Decision-Log-Guide) 涵盖基础知识——什么是 ADL、每个 ADR 必须回答的五个问题，以及真实范例。如果你是 ADR 新手，从那里开始。
...
- **[第一部分：實用指南](/zh-CN/2026/01/Architecture-Decision-Log-Guide)** — 學習基礎知識：什麼是 ADR、每個 ADR 必須回答的五個問題、真實電商範例，以及可直接複製的模板。
